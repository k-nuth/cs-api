...
namespace console
{
    public class Program {
        ...
        public static void TestNative() {
            ...
            Console.WriteLine($"bch_descartes:            {blockchainSettings.bch_descartes}");
            Console.WriteLine($"bch_descartes:            {blockchainSettings.bch_descartes}");
            Console.WriteLine($"galois_activation_time:   {blockchainSettings.galois_activation_time}");
            Console.WriteLine($"leibniz_activation_time:  {blockchainSettings.leibniz_activation_time}");
            ...
            Console.WriteLine($"db_mode:                  {dbSettings.db_mode}");
        ...
        public static void TestsFromFile() {
            var config = Knuth.Config.Settings.GetFromFile("/Users/fernando/dev/kth/cs-api/tests/bch/config/valid.cfg");
            if ( ! config.Ok) {
